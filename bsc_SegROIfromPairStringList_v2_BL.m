function bsc_SegROIfromPairStringList_v2_BL()
...
loadTxt=fileread(fullfile(pwd,'ROIfiles.txt'));
mergedROIs=strsplit(loadTxt,'\n');
mergedROIs=mergedROIs(~cellfun('isempty',mergedROIs));
